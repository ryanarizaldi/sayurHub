...
import styles from './buyerUser.module.css';
import {NavLink, Route} from 'react-router-dom';
import ModalEdit from '../userDashboard/ModalEditUser';
import SkeletonProfile from '../skeletons/SkeletonProfile';
import * as actionTypes from '../../redux/action/Action';


function BuyerUser(props) {
...
export default connect(mapStateToProps, mapDispatchToProps)(BuyerUser);