...
function EditProductModal(props) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      suplier: productData.farmer_supllier,
      ...
      <div className={styles.ContainerModal}>
        ...
        <form className={styles.Form} onSubmit={formik.handleSubmit}>
          ...
          <input
            ...
            name="nutrition"
            id="nutrition"
            value={formik.values.nutrition ? formik.values.nutrition : null}
            className={
          ...
          <button type="submit">
            {formik.isSubmitting ? "Submitting..." : "Edit"}
          </button>
        </form>
      </div>
    </Modal>
...
const mapDispatchToProps = (dispatch) => {
  return {
    editProduct: (values, id, state, onClose) =>
      dispatch(actionTypes.editProduct(values, id, state, onClose)),
  };
};
